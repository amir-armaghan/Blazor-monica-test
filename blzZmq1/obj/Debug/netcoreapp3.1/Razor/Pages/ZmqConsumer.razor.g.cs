#pragma checksum "C:\Users\armaghan\source\repos\blzZmq1\blzZmq1\Pages\ZmqConsumer.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c01323ee8d6135137c4297fcbc9eebec27a67302"
// <auto-generated/>
...
#nullable disable
            ...
            __builder.AddContent(8, "Download CSV file");
            __builder.CloseElement();
            __builder.CloseElement();
...
#nullable disable
            ...
            __builder.AddAttribute(14, "class", "fixwidth");
            __builder.AddContent(15, 
#nullable restore
#line 17 "C:\Users\armaghan\source\repos\blzZmq1\blzZmq1\Pages\ZmqConsumer.razor"
                     answer
...
#line 20 "C:\Users\armaghan\source\repos\blzZmq1\blzZmq1\Pages\ZmqConsumer.razor"
    ...
    async Task GetMassage() // call ZmqProducer calss
    {
        ...
        //using (var producer = new RequestSocket())
        {
            ...
            string jsonFile = ("wwwroot/export/1.json");   // static address for export for test perpose at first run
            if (!File.Exists(jsonFile))
                File.WriteAllText("wwwroot/export/1.json", answer);

            // call runConsumer Method()
            CsvLink = Services.ZmqConsumer.RunConsumer(answer);
